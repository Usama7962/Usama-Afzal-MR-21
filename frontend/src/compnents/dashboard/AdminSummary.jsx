...
const AdminSummary = () => {
  return (
    <div className='p-6'>
        ...
        <div className='grid grid-col-1 md:grid-cols-3 gap-4 mt-6'>
            <SummaryCard icon={<FaUsers/>} text="Total Employees" number={13}color='bg-teal-600'/>
            <SummaryCard icon={<FaBuilding/>} text="Total Department" number={3}color='bg-yellow-600'/>
            <SummaryCard icon={<FaMoneyBillWave/>} text="Monthly Salary" number="$666"color='bg-red-600'/>
             </div>
             <div className='mt-12'>
